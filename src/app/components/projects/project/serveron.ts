...
const skills = [
  ...
  { name: 'Terraform', image: 'assets/skills/terraform.png' },
...
const images = [
  'assets/projects/serveron/dashboard.png',
  'assets/projects/serveron/new_project.png',
  'assets/projects/serveron/logs.png',
];
const link = null;

export const serveron = new Project(
  projectName,
  description,
  skills,
  features,
